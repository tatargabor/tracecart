...
- **THEN** the status bar shows "set-trace: 79.7% | 24✓ 3⚠ 5✗"
...
- **THEN** the status bar shows forward and reverse: "set-trace: 79.7% ↔ 85.0%"
...
- **WHEN** the user clicks the set-trace status bar item
